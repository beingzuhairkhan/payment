        ...
        <div className="min-h-screen bg-gradient-to-br from-primary-50 to-secondary-50 dark:from-gray-900 dark:to-gray-800 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
            <div className="max-w-md w-full">
                <div className="card">
                    ...
                    <div className="bg-yellow-100 text-yellow-800 border border-yellow-300 rounded-md p-4 text-center text-sm sm:text-base md:text-base lg:text-base max-w-lg mx-auto my-4 shadow-sm">
                        <p className="font-medium">
                            ⚠️ Note: Backend is being deployed on Render. It may take a few moments to start up.
                        </p>
                    </div>
                    {/* Header */}
